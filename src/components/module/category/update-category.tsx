...
const UpdateCategory = ({
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black opacity-80">
      <Card className="w-full max-w-sm mx-auto z-50 bg-white dark:bg-black">
        <CardHeader>
